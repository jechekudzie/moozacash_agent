...
<div id="main-wrapper">
        ...
        <div class="container">
            <div class="header-row">
                <div class="header-column justify-content-start">
                    <!-- Logo
                    ============================= -->
                    <div class="logo me-3"><a class="d-flex" href="{{ url('/') }}" title="MoozaCash Logo"><img
                                src="images/logo-light.png" alt="Mooza Cash" style="width: 80%"/></a></div>
                    <!-- Logo end -->
                    <!-- Collapse Button
                    ============================== -->
    ...
    <div id="content">
            ...
            <div class="hero-content d-flex min-vh-100">
                <div class="container my-auto py-5">
                    <div class="row mt-4 pt-5">
                        <div class="col-lg-6 col-xl-7 my-auto text-center text-lg-start pb-4 pb-lg-0">
                            <h2 class="text-14 fw-400 text-white mb-4">The Secure,<br class="d-none d-xl-block">
                                easiest and fastest <br class="d-none d-xl-block">
                                way to transfer money.</h2>
                            <p class="lead text-light mb-4">Send & Receive money to your loved ones in minutes with
                                great rates and low
                        ...
                        <div class="col-lg-6 col-xl-5 my-auto">
                            <ul class="nav nav-tabs nav-justified alternate bg-white rounded-top" id="myTab"
                                role="tablist">
                                <li class="nav-item"><a class="nav-link active" id="send-money-tab" data-bs-toggle="tab"
                                                        href="#send-money" role="tab" aria-controls="send-money"
                                                        aria-selected="true">Send Money</a></li>
                                <li class="nav-item"><a class="nav-link" id="request-money-tab" data-bs-toggle="tab"
                                    ...
                                    <form id="form-send-money" method="post">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" data-bv-field="youSend"
                                                       id="youSend" value="1,000" placeholder="">
                                                <span class="input-group-text p-0">
                          <select id="youSendCurrency" class="selectpicker bg-transparent form-control"
                            ...
                            <option data-icon="currency-flag currency-flag-huf me-1" data-subtext="Hungarian forint"
                                    value="">HUF</option>
                            <option data-icon="currency-flag currency-flag-idr me-1" data-subtext="Indonesian rupiah"
                                    value="">IDR</option>
                            ...
                            <option data-icon="currency-flag currency-flag-mxn me-1" data-subtext="Mexican peso"
                                    value="">MXN</option>
                            <option data-icon="currency-flag currency-flag-myr me-1" data-subtext="Malaysian ringgit"
                                    value="">MYR</option>
                            ...
                            <option data-icon="currency-flag currency-flag-npr me-1" data-subtext="Nepalese rupee"
                                    value="">NPR</option>
                            <option data-icon="currency-flag currency-flag-nzd me-1" data-subtext="New Zealand dollar"
                                    value="">NZD</option>
                            <option data-icon="currency-flag currency-flag-pen me-1" data-subtext="Peruvian nuevo sol"
                                    value="">PEN</option>
                            ...
                            <option data-icon="currency-flag currency-flag-try me-1" data-subtext="Turkish lira"
                                    value="">TRY</option>
                            <option data-icon="currency-flag currency-flag-uah me-1" data-subtext="Ukrainian hryvnia"
                                    value="">UAH</option>
                          ...
                          <select id="recipientCurrency" data-style="form-select bg-transparent border-0"
                                  ...
                                  class="selectpicker bg-transparent form-control" required="">
                            <optgroup label="Popular Currency">
                            <option data-icon="currency-flag currency-flag-usd me-1" data-subtext="United States dollar"
                                    value="">USD</option>
                            <option data-icon="currency-flag currency-flag-aud me-1" data-subtext="Australian dollar"
                            ...
                            <option data-icon="currency-flag currency-flag-zar me-1" data-subtext="South African rand"
                                ...
                                <div class="tab-pane fade" id="request-money" role="tabpanel"
                                     aria-labelledby="request-money-tab">
                                    <form id="form-request-money" method="post">
                                        <div class="mb-3">
                                            <label for="myCountrie" class="form-label">I am in</label>
                                            <select id="myCountrie" data-style="form-select"
                                        ...
                                        <div class="mb-3">
                                            <label for="mypayerCountrie" class="form-label">My payer is in</label>
                                            <select id="mypayerCountrie" data-style="form-select"
                                                    class="selectpicker form-control" data-live-search="true">
                                                <option value="244">Aaland Islands</option>
                                                <option value="1">Afghanistan</option>
                                                <option value="2">Albania</option>
                                        ...
                                        <div class="mb-4">
                                            <label for="wantTorequest" class="form-label">I want to request</label>
                                            <div class="input-group">
                                                <span class="input-group-text">$</span>
                                                <input type="text" class="form-control" data-bv-field="wantTorequest"
                                                       id="wantTorequest" value="1,000" placeholder="">
                                                <span class="input-group-text p-0">
        ...
        <section class="section bg-white">
            <div class="container">
                <h2 class="text-9 text-center text-uppercase fw-400">Why choose us?</h2>
                        ...
                        <div class="row g-4">
                            <div class="col-sm-6">
                                <div class="featured-box style-3">
                                    ...
                                    <h3 class="fw-400">Easy to use</h3>
                            ...
                            <div class="col-sm-6">
                                <div class="featured-box style-3">
                                    <div class="featured-box-icon border border-primary text-primary rounded-circle"><i
                                            class="fas fa-share"></i></div>
                                    <h3 class="fw-400">Faster Payments</h3>
        ...
        <section class="section">
            <div class="container">
                <h2 class="text-9 text-center text-uppercase fw-400">As simple as 1-2-3</h2>
                    ...
                    <div class="col-sm-4">
                        <div class="featured-box style-4">
                            <div class="featured-box-icon text-dark shadow-none border-bottom"><span
                                    class="w-100 text-20 fw-500">1</span></div>
                            <h3 class="mb-3">Sign Up Your Account</h3>
                            <p class="text-3 fw-300">Sign up for your free personal/business Account in fea a
                                minute.</p>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="featured-box style-4">
                            <div class="featured-box-icon text-dark shadow-none border-bottom"><span
                                    class="w-100 text-20 fw-500">2</span></div>
                            <h3 class="mb-3">Send & Receive Money</h3>
                            <p class="text-3 fw-300">Receive & Send Payments from worldwide in 40 currencies.</p>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="featured-box style-4">
                            <div class="featured-box-icon text-dark shadow-none border-bottom"><span
                                    class="w-100 text-20 fw-500">3</span></div>
                            <h3 class="mb-3">Withdraw Funds</h3>
                            <p class="text-3 fw-300">Your funds will be transferred to your local bank account.</p>
                        </div>
                    </div>
                </div>
                <div class="text-center mt-5"><a href="#" class="btn btn-primary">Open a Free Account</a></div>
            </div>
        </section>
        <!-- How it works End -->
        ...
        <section class="section bg-white">
            <div class="container">
                <h2 class="text-9 text-center text-uppercase fw-400">What can you do?</h2>
                <p class="lead text-center mb-5">Lorem Ipsum is simply dummy text of the printing and typesetting
                    industry.</p>
                <div class="row g-4">
                ...
                <div class="text-center mt-5"><a href="#" class="btn-link text-4">See more can you do<i
                            class="fas fa-chevron-right text-2 ms-2"></i></a></div>
            </div>
        </section>
        <!-- What can you do End -->
        ...
        <section class="hero-wrap section shadow-md">
            ...
            <div class="hero-content py-0 py-lg-5 my-0 my-lg-5">
                <div class="container text-center">
                    <h2 class="text-9 text-white fw-400 text-uppercase mb-5">What our customers say</h2>
                    <a class="video-btn d-flex" href="#" data-src="https://www.youtube.com/embed/7e90gBu4pas"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-lg-9 col-xl-8 mx-auto">
                        <div class="row">
                            <div class="col-sm-5 text-center align-bottom order-1 order-sm-0"><img class="img-fluid"
                                                                                                   alt=""
                                                                                                   src="images/app-mobile.png">
                            </div>
                            <div class="col-sm-7 my-auto order-0 order-sm-1 text-center text-sm-start">
                                <h2 class="text-9 fw-400 text-uppercase mb-3">Get the app</h2>
                                <p class="lead">Download our app for the fastest, most convenient way to send & get
                                    Payment.</p>
                                <div class="pt-2 mb-4 mb-sm-0"><a class="me-3" href=""><img class="img-fluid" alt=""
                                                                                            src="images/app-store.png"></a><a
                                        href=""><img class="img-fluid" alt="" src="images/google-play-store.png"></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md mb-3 mb-md-0">
                    <h4 class="text-3 text-muted text-uppercase fw-400 mb-3">Information</h4>
                ...
                <div class="col-sm-6 col-md mb-3 mb-md-0">
                    <h4 class="text-3 text-muted text-uppercase fw-400 mb-3">Services</h4>
                    <ul class="nav flex-column">
                ...
                <div class="col-sm-6 col-md mb-3 mb-md-0">
                    <h4 class="text-3 text-muted text-uppercase fw-400 mb-3">Help Center</h4>
                    <ul class="nav flex-column">
                ...
                <div class="col-sm-6 col-md mb-3 mb-md-0">
                    <h4 class="text-3 text-muted text-uppercase fw-400 mb-3">Keep in touch</h4>
                    <ul class="nav flex-column">
                ...
                <div class="col-12 col-lg-3">
                    <h4 class="text-3 text-muted text-uppercase fw-400 mb-3">Subscribe</h4>
                    ...
                    <div class="input-group newsletter">
                        ...
                        <button class="btn btn-secondary shadow-none px-3" type="button" data-bs-toggle="tooltip"
                                title="Subscribe"><i class="fas fa-paper-plane"></i></button>
                    </div>
                </div>
            </div>
        </div>
